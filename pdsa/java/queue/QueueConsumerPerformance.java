...
import pdsa.stack.Stack;
import pdsa.utility.Performance;

public class QueueConsumerPerformance {

    public static void main(String[] args) {

        Performance pf = new Performance();
        pf.setNoOfTests(10000000);

        System.out.println("Queue performance evaluation - " + pf.getFormatedNumber() + " add\n");
